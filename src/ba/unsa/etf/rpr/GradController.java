...
public class GradController {
    ...
    public void initialize() {
        ...
        if (grad != null) {
            ...
            cbOlimpijski.setSelected(grad.isOlimpijski());
        } else {
    ...
    public void clickOk(ActionEvent actionEvent) {
        ...
        if (!choiceDrzava.getValue().isOlimpijska() && cbOlimpijski.isSelected()) {
            sveOk = false;
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Greška");
            alert.setHeaderText("Neispravni podaci");
            alert.setContentText("Država " + choiceDrzava.getValue() + " nije olimpijska država");
        ...
        grad.setOlimpijski(cbOlimpijski.isSelected());
        Stage stage = (Stage) fieldNaziv.getScene().getWindow();
        stage.close();
    }
}
